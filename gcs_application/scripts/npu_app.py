...
class Container(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.paint_layer
        """
        self.host_telemetry = "192.168.166.100"
        self.port_telemetry = "4501"

        self.host_mission_manager = "192.168.166.100"
        ...
        self.sub_pose = zmq_wrapper_lib.Subscriber("192.168.166.100", "4501")
    ...
    def telemetry_thread(self):
        ...
        while True:
            if self.sub_pose.msg:
                telemetry_translate = self.sub_pose.msg
                # socket.send(b"")
